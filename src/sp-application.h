...
GtkApplication * sp_application_new(void);
static void      sp_activate_main_window(gboolean directory_provided, char * default_directory_name,
                                         GApplication *application); 

G_END_DECLS

#endif /* SP-APPLICATION.H */
